...
ширина); отметьте **Show all fonts**, чтобы выбрать любой установленный шрифт.
Ползунок **Text size** масштабирует цифры от 25% до 100% (50% — подогнанный
размер; выше широкие значения могут вылезать за края); шрифт и размер сразу
видны в трее, диалог закрывать не нужно.
